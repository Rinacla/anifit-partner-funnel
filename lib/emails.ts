  ...
  return {
    ...
    html: WRAPPER(`
      ...
      <div class="highlight">
        ...
        Du kaufst ein Einstiegspaket (ab 78 \u20ac) und bekommst nach der Startschulung <strong>Warenproben im gleichen Wert GRATIS oben drauf</strong>.<br><br>
        Bestellst du f\u00fcr 80 \u20ac, bekommst du 80 \u20ac extra. Bestellst du f\u00fcr 160 \u20ac, bekommst du 160 \u20ac extra.
      </div>
      ...
      <p>Enrico</p>
    `, "5 Minuten Registrierung + Warenproben im gleichen Wert gratis oben drauf."),
  };
}
  ...
  return {
    ...
    html: WRAPPER(`
      ...
      <ul>
        ...
        <li>\u2705 Einstiegspaket ab 78 \u20ac + Warenproben im gleichen Wert GRATIS oben drauf</li>
...
export function followUp1Email(name: string) {
  return {
    ...
    html: WRAPPER(`
      ...
      Du bekommst Warenproben im gleichen Wert gratis oben drauf. Bestellst du f\u00fcr 78 \u20ac, bekommst du 78 \u20ac extra. Mit deinen ersten 3\u20134 Kunden hast du die Kosten drin. Und mit dem Startbonus verdienst du sofort 30 %.</p>
  ...
  return {
    ...
    html: WRAPPER(`
      ...
      <ul>
        ...
        <li>78 \u20ac Einstieg + Warenproben im gleichen Wert gratis oben drauf</li>
